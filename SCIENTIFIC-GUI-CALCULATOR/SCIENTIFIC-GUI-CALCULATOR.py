# SCIENTIFIC GUI CALCULATOR USING PYTHON WITH FUll SOURCE CODE By Coder Mohit.
# Visit : Www.CoderMohit.com
...
root.title("Scientific Calculator By Coder Mohit")
...
def abt():
    abt = "This calculator was developed using Tkinter, by Mohit Goyal (CoderMohit.Com), who is a student of Dayalbagh Educational Institute University."
...
mainmenu.add_command(label="Website",command=website)
mainmenu.add_command(label="YouTube",command=youtube)
...
btn3 = Calculator("log",1,3,sciCal,"grey")

btn4 = Calculator("ln",1,4,sciCal,"grey")
...
btn10 = Calculator("π",3,0,sciCal,"skyblue")

btn11 = Calculator("1/x",3,1,sciCal,"skyblue")

btn12 = Calculator("deg",3,2,sciCal,"skyblue")

btn13 = Calculator("rad",3,3,sciCal,"skyblue")

btn14 = Calculator("e",3,4,sciCal,"skyblue")
...
btn34 = Calculator("=",7,4,calculate,"green")
